...
def users_show(user_id):
    ...
    messages = (Message
                ...
                .limit(100)
                .all())
    return render_template('users/show.html', user=user, messages=messages, user_likes_msg_id=user_likes_msg_id)
...
# msg = Message.query.get(message_id)
    user = g.user
    liked_msg = Likes.query.get(user_id)
